        ...
        <div className="w-full px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-5">
              <h1 className="font-sans text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white leading-tight drop-shadow-2xl">
                Authentic <span className="text-amber-300">Flavors</span>, Straight From <span className="text-orange-200">The Kitchen</span>
              </h1>

              <p className="text-xs sm:text-sm md:text-base text-white leading-relaxed max-w-sm font-semibold drop-shadow-lg">
            ...
            <div className="relative flex items-center justify-center">
              <div className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-3xl overflow-hidden border-4 border-white/30 shadow-2xl">
                <img 
