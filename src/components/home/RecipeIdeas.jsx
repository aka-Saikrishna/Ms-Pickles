      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[400px] md:h-[500px]" ref={pRef}>
            <div
              className={`absolute top-0 left-0 w-[60%] h-[40%] rounded-2xl overflow-hidden shadow-2xl transition-all duration-1000 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}
            ...
            <div
              className={`absolute bottom-0 right-0 w-[60%] h-[45%] rounded-2xl overflow-hidden shadow-2xl transition-all duration-1000 delay-300 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}
